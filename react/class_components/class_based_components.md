...
For the purposes of this assignment, we take the simple class-based component that we built and try to improve it by adding additional functionality. There is an interactive example provided at the end that you can work on.
