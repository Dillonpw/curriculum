...
For the purposes of this assignment, we take the simple class-based component that we built and add some additional functionality to it. There is an interactive example provided at the end to build upon.
